...
public class TextureManager {
    ...
    /**
     * Pointer to the main resource manager.
     */
    ...
    public void loadTexture(String resource, int filter, int wrap) throws Exception {
        ...
        try {
            ...
            ByteBuffer buf = convertImageData(resourceManager.resourceLoader.loadImage(resource), tex);
    ...
    public void preload(String root) {
        if(resourceManager.getMode() == ResourceManager.LOAD_FROM_JAR) {
            getTexture("assets/graphics/backgrond.png");
            getTexture("assets/graphics/characters.png");
            getTexture("assets/graphics/actors/cockEnemy.png");
            getTexture("assets/graphics/actors/aidsCockEnemy.png");
            getTexture("assets/graphics/actors/gonorrheaCockEnemy.png");
            getTexture("assets/graphics/actors/chlamydiaCockEnemy.png");
            getTexture("assets/graphics/actors/rottenCockEnemy.png");
            getTexture("assets/graphics/actors/condomRocket.png");
            getTexture("assets/graphics/actors/doubleBlaster.png");
            getTexture("assets/graphics/actors/rubberBlast.png");
            getTexture("assets/graphics/actors/rubberBlaster.png");
            getTexture("assets/graphics/actors/hormoneShot.png");
            getTexture("assets/graphics/actors/pickups.png");
        }
        else {
